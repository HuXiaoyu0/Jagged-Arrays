...
int main(int argc, char* argv[]) {
  if (argc == 1) {
    SimpleTest();   std::cout << "Simple test completed." << std::endl;
    StudentTests();
...
void StudentTests() {
  ...
  assert (ja.numElementsInBin(5) == 0);
  assert (ja.numElementsInBin(6) == 1);
  assert (ja.getElement(1,0) == 1);
  assert (ja.getElement(1,1) == 2);
  assert (ja.getElement(1,2) == 3);
  assert (ja.getElement(3,0) == 4);
  assert (ja.getElement(3,1) == 5);
  assert (ja.getElement(6,0) == 6);
